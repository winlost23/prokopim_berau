...
<div class="container-fluid">
            ...
            <div class="page-title-box">
                <div class="float-right">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">Edit Pantun</li>
                    </ol>
                </div>
                <h4 class="page-title">Edit Pidato Pantun (<?= $pidato->pidato_detail_judul ?>)</h4>
            </div>
            <!--end page-title-box-->
        </div>
        <!--end col-->
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    <h4 class="mt-0 header-title">Form Edit Pidato Pantun (<?= $pidato->pidato_detail_judul ?>)</h4>
                    <p class="text-muted mb-3">Silahkan ubah form dibawah ini...</p>
                    <?= $validation->getErrors() ? $validation->listErrors('my_list') : '' ?>
                    <div class="general-label">
                        <form method="post" action="<?= base_url('nimda/pidato/pantun_update/' . $pidato->pidato_detail_id . '/' . $pantun->pidato_pantun_id) ?>" enctype="multipart/form-data">
                            <?= csrf_field(); ?>
                            <input type="hidden" name="pidato_pantun_id" value="<?= $pantun->pidato_pantun_id ?>">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <textarea id="elm1" name="pidato_pantun_isi" class="form-control <?= ($validation->hasError('pidato_pantun_isi')) ? 'is-invalid' : '' ?>" id="pidato_pantun_isi"><?= (old('pidato_pantun_isi')) ? old('pidato_pantun_isi') : $pantun->pidato_pantun_isi ?></textarea>
