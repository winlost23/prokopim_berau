...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-lg-4">
            <div class="card">
                <div class="card-body">
                    <h4 class="mt-0 header-title">Form Edit Kategori <?= ucfirst($segmentasi); ?></h4>
                    <p class="text-muted mb-3">Silahkan lengkapi form dibawah ini...</p>
                    <div class="general-label">
                        <form method="post" action="<?= base_url('nimda/kategori/update/' . $segmentasi) ?>" enctype="multipart/form-data">
                            <?= csrf_field(); ?>
                            ...
                            <div class="row">
                                <div class="col-sm-9 ml-auto">
                                    ...
                                    <a href="<?= base_url() ?>/nimda/kategori/index/<?= $segmentasi ?>" class="btn btn-gradient-danger">Cancel</a>
                                </div>
                            </div>
                        </form>
                    </div>
