        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <h4 class="mt-0 header-title">List Info</h4>
                    <p class="text-muted mb-3">Berikut adalah semua data Info yang ada pada system ini...</p>
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <a href="<?= base_url('nimda/info/edit/' . $u->info_id) ?>" class="mr-2"><i class="fas fa-edit text-info font-16"></i></a>
                                        <a href="<?= base_url('nimda/info/delete/' . $u->info_id) ?>" onclick="return confirm('are you sure?')"><i class="fas fa-trash-alt text-danger font-16"></i></a>
                                    </td>
                                </tr>
                            <?php endforeach; ?>
                        </tbody>
