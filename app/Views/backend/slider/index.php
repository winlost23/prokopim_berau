        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <?php endif; ?>
                    <a href="<?= base_url('nimda/slider/add') ?>" class="btn btn-gradient-secondary btn-clipboard" data-clipboard-action="copy" data-clipboard-target="#clipboardTextarea"><i class="fas fa-plus mr-2"></i>Tambah Slider</a>
                    <br>
                    <br>
