...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    <h4 class="mt-0 header-title">Form Edit Slider</h4>
                    <p class="text-muted mb-3">Silahkan ubah form dibawah ini...</p>
                    <?= $validation->getErrors() ? $validation->listErrors('my_list') : '' ?>
                    <div class="general-label">
                        <form method="post" action="<?= base_url('nimda/slider/update/' . $slider->slider_id) ?>" enctype="multipart/form-data">
                            <?= csrf_field(); ?>
                            <input type="hidden" name="slider_gambar_lama" value="<?= $slider->slider_gambar ?>">
                            <input type="hidden" name="slider_id" value="<?= $slider->slider_id ?>">
                            <div class="form-group row">
                                <label for="nama" class="col-sm-3 col-form-label">Text 1</label>
                                <div class="col-sm-9">
                                    <input type="text" class="form-control <?= ($validation->hasError('judul')) ? 'is-invalid' : '' ?>" id="slider_judul_1" name="slider_judul_1" autofocus value="<?= (old('slider_judul_1')) ? old('slider_judul_1') : $slider->slider_judul_1 ?>">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control <?= ($validation->hasError('judul')) ? 'is-invalid' : '' ?>" id="slider_judul_2" name="slider_judul_2" autofocus value="<?= (old('slider_judul_2')) ? old('slider_judul_2') : $slider->slider_judul_2 ?>">
                                    <div class="invalid-feedback">
                            ...
                            <div class=" form-group row">
                                ...
                                <div class="col-sm-9">
                                    ...
                                    <img src="<?= base_url() ?>/img/slider/<?= $slider->slider_gambar; ?>" class="img-thumbnail img-preview" style="width: 150px;">
                                </div>
                            </div>
                            <hr />
                            <div class="row">
